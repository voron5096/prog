...
<br>
В чём же её особенности? Этот относительно простой алгоритм сортировки, также по совместительству является прокаченной модификацией пузырьковой сортировки.
<br>
